...
function loadPlaces(map) {
  ...
  _axios2.default.get('/api/stores/near?lat=' + lat + '&&lng=' + lng).then(function (res) {
    var places = res.data;
    if (!places.length) {
      alert('no places found'); // change this to an alert at the top of the page
      return;
    }
    // create a bounds to center and zoom map appropriately
    ...
    // then zoom the map to fit the bounds
